...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="iOSPhotoEditor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14iOSPhotoEditor8CropView")
...
SWIFT_CLASS("_TtC14iOSPhotoEditor18CropViewController")
...
///   </li>
/// </ul>
SWIFT_PROTOCOL("_TtP14iOSPhotoEditor19PhotoEditorDelegate_")
...
SWIFT_CLASS("_TtC14iOSPhotoEditor25PhotoEditorViewController")
...
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull hiddenControls;
- (void)loadView;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface PhotoEditorViewController (SWIFT_EXTENSION(iOSPhotoEditor)) <UITextViewDelegate>
...
@interface PhotoEditorViewController (SWIFT_EXTENSION(iOSPhotoEditor))
...
@interface PhotoEditorViewController (SWIFT_EXTENSION(iOSPhotoEditor)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer * _Nonnull)otherGestureRecognizer SWIFT_WARN_UNUSED_RESULT;
